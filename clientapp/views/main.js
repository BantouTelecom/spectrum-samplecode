...
module.exports = BaseView.extend({
    ...
    showDialer: function () {
        var dialer = new DialerView({model: this.model}),
            dialog = ui.dialog(dialer.render(true).el).overlay().closable().show();
        
        dialer.dialog = dialog;

        dialog.on('close', _.bind(dialer.destroy, dialer));
    },
