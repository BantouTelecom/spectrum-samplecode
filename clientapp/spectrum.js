...
module.exports = BaseModel.extend({
    ...
    initialize: function () {
        ...
        // bind event from att strophe plugin
        $(document).on('message', _.bind(this.handleMessageReceived, this));
        $(document).on('presence', _.bind(this.handlePresence, this));
        $(document).on('sipAddress', _.bind(this.handleSipAddress, this));
        $(document).on('unavailable', _.bind(this.handleUnavailable, this));
    },
    blastOff: function () {
    ...
    showConversation: function (contact) {
        var convo = app.conversations.getOrNew(contact.id);
