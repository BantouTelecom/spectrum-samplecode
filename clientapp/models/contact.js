...
module.exports = BaseModel.extend({
    ...
    getCallableNumber: function () {
        ...
        if (work) return this.cleanPhoneNumber(work.value);
        if (home) return this.cleanPhoneNumber(home.value);
        return;
    },
    //We use the model to get at util.cleanPhoneNumber so other things don't need to include it
    cleanPhoneNumber: function (n) {
        return util.cleanPhoneNumber(n);
    }
});
