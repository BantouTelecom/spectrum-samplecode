                ...
                req.onreadystatechange = function() {
                    if (req.readyState == 4) {
                        ...
                        if (req.status == 202 || req.status == 201) {
                            ...
                            var match = resourceUrl.match("audiovideo/([a-z0-9\-]+)");
                            _call._callID = match[1];
                        } else {
        ...
        this.processRoapOffer = function(mediaServices, sdp) {
            ...
            for (mediaIndex in sdp) {
                ...
                for(attributeIndex in sdp[mediaIndex].attributes) {
                    ...
                    var attr = sdp[mediaIndex].attributes[attributeIndex].a;
                    
                    if (attr.indexOf("horizon") != -1)
                        continue;
                    
                    if (attr.indexOf("BUNDLE") != -1)
                        continue;
                    
                    if (attr.indexOf("BUNDLE") != -1)
                        continue;
                        
                    if (attr.indexOf("mid:2") != -1)
                        attr = "mid:audio";
